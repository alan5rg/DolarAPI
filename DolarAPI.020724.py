...
#02.07.24//se acualiza por cambios en la estructura del diccionario de la API al cambiar plazos de 48hrs a 24hrs
import sys, os
import requests
import json
...
class MainWindow(QMainWindow):
    ...
    def update_chart(self):
        ...
        dixyDolar = {"blueX":[], "cripto":[], "mep24":[], "cclCI":[]}
        """
        ...
        dixyDolar['mep24'].append(usd_values['mep']['al30']['24hs'])
        ...
        newvalues = [values[0]['ask'],values[1]['ccb']['ask'],values[2]['al30']['24hs']['price'],values[3]['lede']['ci']['price']]
